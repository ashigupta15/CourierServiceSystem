...
import com.example.home_2.courierservicesystem.ViewCourierDetails;
...
public class ShowCourierIdDetails extends AppCompatActivity {
...
public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(ShowCourierIdDetails.this,ViewCourierDetails.class);
...
private class GetHttpResponse extends AsyncTask<Void, Void, Void>
{
    ...
    {
        HttpService httpService = new HttpService(com.ashi.courierservicesystem.IpAddresses.URL_COURIER_ID+s1);
        try
        {
                ...
                if(result != null)
                {
                    ...
                    try {
                        ...
                        for(int i=0; i<jsonArray.length(); i++)
                        {
                            ...
                            college.driverName = object.getString("sender");
                            college.fromPlace = object.getString("sender_address");
                            college.toPlace = object.getString("receiver");
                            college.arrivalDate = object.getString("receiver_address");
                            college.arrivalTime = object.getString("delivery_id");
                            college.departureDate = object.getString("collecting_person_name");
                            college.departureTime = object.getString("delevery_person_name");
                            college.durationTime = object.getString("delivery_status");
                            college.amountPayable = object.getString("user_intimation_status");
