...
import com.example.home_2.courierservicesystem.UserRegistration;
...
public class UserLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2=(Button)findViewById(R.id.btn_registration_user);
    ...
    public void login() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(UserLogin.this,R.style.AppTheme);
    ...
    public void loginUser(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, com.ashi.courierservicesystem.IpAddresses.URL_USER_LOGIN, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                if(s.equalsIgnoreCase("success")){
                    ...
                    Intent i= new Intent(UserLogin.this, com.ashi.courierservicesystem.UserHome.class);
