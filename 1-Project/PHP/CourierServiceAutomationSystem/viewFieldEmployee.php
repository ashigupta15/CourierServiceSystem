									...
									<div class="col-full">
										<table class="tablestyle">
											<tr>
												...
												<th style="border:1px solid black">Employee Area</th>
												<th style="border:1px solid black">Address Allocated</th>
												<th style="border:1px solid black">Type Of Service</th>
										...
										while($row=mysql_fetch_array($quer))
										{
											...
											<tr>
												...
												<td style="border:1px solid black"><?= $row['addrss_allocated'];?></td>
