				...
				<div id="main-content">
					<div class="wrap-content zerogrid ">
						...
						<form method="post">
								...
								<td><input type="tel" value="Employee Area" class="textbox" readonly /></td><td><input type="text" name="employeearea" placeholder="Enter Employee area"></td>
								</tr><tr>
								...
								if(isset($_POST["submitbtn"]))
								{
									...
									$emparea=mysql_real_escape_string($_POST['employeearea']);
									...
									if(mysql_query("INSERT INTO employee(employee_id, employee_name, employee_designation, employee_experience, employee_email_id, employee_mobile_number, employee_address, employee_category, employee_area, addrss_allocated, type_of_service,item_id, note) 
										VALUES ('".$empid."','".$empname."','".$empdes."','".$empexp."','".$empemid."','".$empmob."','".$empaddr."','".$empcat."','".$emparea."','".$allo."','".$allo."','".$allo."','".$empnotes."')"))
										{
											?>
											 <script>
												alert('successfully registered ');
												window.location.href='viewFieldEmployee.php';
											</script>
											<?php
										}
										else
