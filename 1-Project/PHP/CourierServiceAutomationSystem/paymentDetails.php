	...
	<header class="zerogrid">
		...
		<div id='cssmenu' class="align-center">
			<ul>
			  ...
			  <li class="active"><a href='paymentDetails.php'><span>Payment Details	</span></a></li>
								...
								<div class="row">
									<table  class="tablestyle">
										<tr>
											...
											<th style="border:1px solid black">Material Weight</th>
											<th style="border:1px solid black">Cost<br/>(in Rupees)</th>
											<th style="border:1px solid black">Payment Mode</th>
											<th style="border:1px solid black">Payment Received by</th>
										</tr>
											<?php
											$empcat="management";
										$quer=mysql_query("SELECT * FROM payment_details");
										$s=1;
										while($row=mysql_fetch_array($quer))
										{
											...
											<tr>
												...
												<td style="border:1px solid black"><?= $row['sender_name'];?></td>
												<td style="border:1px solid black"><?= $row['item_id'];?></td>
												<td style="border:1px solid black"><?= $row['material_type'];?></td>
												<td style="border:1px solid black"><?= $row['material_weight'];?></td>
												<td style="border:1px solid black"><?= $row['amount_payable'];?></td>
												<td style="border:1px solid black"><?= $row['payment_mode'];?></td>
												<td style="border:1px solid black"><?= $row['payment_received_by'];?></td>
												<?php
											++$s;
										}
										?>
