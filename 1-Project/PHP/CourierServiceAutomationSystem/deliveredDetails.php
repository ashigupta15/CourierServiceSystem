	...
	<header class="zerogrid">
		...
		<div id='cssmenu' class="align-center">
			<ul>
			   ...
			   <li  class="active"><a href='deliveredDetails.php'><span>Delivered Details</span></a></li>
						...
						<article class="background-gray">
							...
							<table class="tablestyle">
								<tr >
									...
									<th style="border:1px solid black">Sender Address</th>
									<th style="border:1px solid black">Received Person</th>
									<th style="border:1px solid black">Receiver Address</th>
									<th style="border:1px solid black">Item Id</th>
									<th style="border:1px solid black">Delivered Person</th>
